...
*
*************************************************************************/
void set_SP0A19_param_exposure(struct sp0a19_device *dev,enum camera_exposure_e para)//�ع����
{
	struct i2c_client *client = v4l2_get_subdevdata(&dev->sd);
...
*
*************************************************************************/
void set_SP0A19_param_effect(struct sp0a19_device *dev,enum camera_effect_flip_e para)//��Ч����
{
    struct i2c_client *client = v4l2_get_subdevdata(&dev->sd);
	unsigned char buf[4];
	switch (para)
