...
static inline void vdin_set_color_matrix1(unsigned int offset, tvin_format_t *tvin_fmt_p, enum vdin_format_convert_e format_convert, enum tvin_port_e port, unsigned int tvin_color_fmt_range_e color_fmt_range)
{
#if defined(VDIN_V1)
	//    unsigned int offset = devp->addr_offset;
...
static inline void vdin_set_color_matrix0(unsigned int offset, tvin_format_t *tvin_fmt_p, enum vdin_format_convert_e format_convert, enum tvin_port_e port, unsigned int tvin_color_fmt_range_e color_fmt_range)
{
	enum vdin_matrix_csc_e    matrix_csc = VDIN_MATRIX_NULL;
	struct vdin_matrix_lup_s *matrix_tbl;
	struct tvin_format_s *fmt_info = tvin_fmt_p;
